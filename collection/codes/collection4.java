     ...
     { 
        ...
        if (ae.getSource() == btnadd) 
         { 
               ...
               { 
                  JOptionPane.showMessageDialog(this, "Invalid input or duplicate entry", 
"Error", JOptionPane.ERROR_MESSAGE); 
               }  
               else  
               { 
                  table.put(name, std); 
                  JOptionPane.showMessageDialog(this, "Successfully Added", "Success", 
JOptionPane.INFORMATION_MESSAGE); 
         ...
         { 
            ...
            { 
                JOptionPane.showMessageDialog(this, "City Removed", "Success", 
JOptionPane.INFORMATION_MESSAGE); 
            } 
             else  
             { 
...
JOptionPane.ERROR_MESSAGE); 
        ...
        { 
            ...
            JOptionPane.showMessageDialog(this, code != null ? "STD Code: " + code : "City not 
found", "Result", JOptionPane.INFORMATION_MESSAGE); 
        } 
    } 
